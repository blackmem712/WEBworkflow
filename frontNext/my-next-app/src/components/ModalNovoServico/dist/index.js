...
function ModalNovoServico(_a) {
    var onClose = _a.onClose, setServicos = _a.setServicos;
    ...
    var handleSalvar = function () {
        fetch('http://127.0.0.1:8000/servicos/api/v1/', {
            ...
            .then(function (novo) {
            setServicos(function (prev) { return __spreadArrays(prev, [novo]); });
            onClose();
        })["catch"](console.error);
    };
    return (React.createElement("div", { className: "modal-overlay" },
        React.createElement("div", { className: "modal-serv wide" },
            React.createElement("h2", null, "Novo Servi\u00E7o"),
...
exports["default"] = ModalNovoServico;
