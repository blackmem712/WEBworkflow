...
function OrcamentosPage() {
    ...
    var _f = react_1.useState([]), clientes = _f[0], setClientes = _f[1];
    var _g = react_1.useState(null), selOrc = _g[0], setSelOrc = _g[1];
    var _h = react_1.useState(false), showNovo = _h[0], setShowNovo = _h[1];
    ...
    return (React.createElement("div", { className: "orc-page" },
        ...
        showNovo && (React.createElement(ModalNovoOrcamento_1["default"], { clientes: clientes, equipamentos: equipamentos, servicos: servicos, produtos: produtos, funcionarios: funcionarios, onClose: function () { return setShowNovo(false); }, setOrcamentos: setOrcamentos }))));
}
