      ...
      <div class="w-full md:w-1/2">
        ...
        <form class="flex-grow max-w-md mr-4"> <!-- Adicionado mr-4 para espaçamento -->
          <label for="default-search"
            class="mb-2 text-sm font-medium text-gray-900 dark:text-gray-200 sr-only">Search</label>
          ...
          <div class="relative flex items-center">
            ...
            <!-- Input de Pesquisa -->
            <input v-model="busca" type="search" id="default-search"
            ...
            <button type="submit" @click.prevent="buscarProdutos"
