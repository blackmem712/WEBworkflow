<template>
    <div v-if="mostrarModal"
        ...
        <div class="relative w-full max-h-screen max-w-4xl p-6 mx-auto bg-white rounded-lg shadow-lg dark:bg-gray-800">
            <!-- Conteúdo do Modal -->
            <div class="relative bg-white rounded-lg dark:bg-gray-800">
                ...
                <form>
                    ...
                    <!-- Campos do Cliente -->
                    <div v-if="iscad" class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
                        <div>
                    ...
                    <div v-if="iscad" class="flex justify-end mt-6">
                    ...
                    <!-- Select de Equipamentos do Cliente -->
...
export default {
    ...
    watch: {
        ...
        equipamentoSelecionado(newEquipamentoId) {
            // Quando um equipamento é selecionado, exibir seus detalhes
            this.equipamentoDetalhes = this.equipamentos.find(equip => equip.id === newEquipamentoId) || {};
        },
